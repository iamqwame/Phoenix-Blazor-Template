(function (factory) {
    ...
    const contactsBySourceChartInit = () => {
        const {
            ...
            getData: t,
            toggleColor: a
        } = window.phoenix.utils, o = document.querySelector(".echart-contact-by-source-container"), r = o.querySelector(".echart-contact-by-source"), i = o.querySelector("[data-label]");
        if (r) {
            const o = t(r, "echarts"),
            ...
            i && (i.innerHTML = c);
            echartSetOption(n, o, (() => ({
                color: [e("primary"), e("success"), e("info"), e("info-light"), a(e("danger-lighter"), e("danger-darker")), a(e("warning-light"), e("warning-dark"))],
                tooltip: {
                    trigger: "item",
                    borderWidth: 0,
    ...
    const contactsCreatedChartInit = () => {
        const {
            ...
            getData: o,
            getPastDates: e
        } = window.phoenix.utils, i = document.querySelector(".echart-contacts-created"), r = e(9), a = [24, 14, 30, 24, 32, 32, 18, 12, 32], n = [36, 28, 36, 39, 54, 38, 22, 34, 52];
        if (i) {
            const e = o(i, "echarts"),
    ...
    const newUsersChartsInit = () => {
        const {
            ...
            getPastDates: e,
            rgbaColor: a
        } = window.phoenix.utils, r = document.querySelector(".echarts-new-users"), i = o => {
            ...
            return a.forEach(((o, t) => {
                r += `<h6 class="fs-9 text-body-tertiary ${t > 0 && "mb-0"}"><span class="fas fa-circle me-2" style="color:${o.color}"></span>\n      ${o.date.format("MMM DD")} : ${o.value}\n    </h6>`;
            })), `<div class='ms-1'>\n              ${r}\n            </div>`
        };
        if (r) {
            const s = t(r, "echarts"),
    ...
    const newLeadsChartsInit = () => {
        const {
            ...
            getPastDates: a,
            rgbaColor: e
        } = window.phoenix.utils, r = document.querySelector(".echarts-new-leads"), i = o => {
            const t = window.dayjs(o[0].axisValue),
    ...
    const addClicksChartInit = () => {
        const {
            ...
            getPastDates: e,
            getItemFromStore: i
        } = window.phoenix.utils, a = document.querySelector(".echart-add-clicks-chart"), r = e(11), l = [2e3, 2250, 1070, 1200, 1e3, 1450, 3100, 2900, 1800, 1450, 1700], n = [1100, 1200, 2700, 1700, 2100, 2e3, 2300, 1200, 2600, 2900, 1900], s = t => {
            ...
            return i.forEach(((t, o) => {
                a += `<h6 class="fs-9 text-body-tertiary ${o > 0 && "mb-0"}"><span class="fas fa-circle me-2" style="color:${t.color}"></span>\n      ${t.date.format("MMM DD")} : ${t.value}\n    </h6>`;
            })), `<div class='ms-1'>\n              ${a}\n            </div>`
        };
        if (a) {
            const e = o(a, "echarts"),
            ...
            echartSetOption(c, e, (() => ({
                ...
                yAxis: {
                    ...
                    splitLine: {
                        show: !0,
                        lineStyle: {
                            color: "dark" === i("phoenixTheme") ? t("body-highlight-bg") : t("secondary-bg")
                        }
                    },
                    axisLine: {
                        show: !1
    ...
    const echartsLeadConversiontInit = () => {
        const {
            ...
            getPastDates: i,
            toggleColor: o
        } = window.phoenix.utils, t = document.querySelector(".echart-lead-conversion"), a = i(4);
        if (t) {
            const i = r(t, "echarts"),
            ...
            echartSetOption(l, i, (() => ({
                ...
                series: {
                    ...
                    data: [{
                        ...
                        emphasis: {
                            itemStyle: {
                                color: o(e("info-light"), e("info-dark"))
                            },
                            label: {
                                formatter: () => "{b| 60% }",
                                rich: {
                        ...
                        emphasis: {
                            itemStyle: {
                                color: o(e("danger-light"), e("danger-dark"))
                            },
                            label: {
                                formatter: () => "{a|100%}",
                                rich: {
                        ...
                        label: {
                            ...
                            rich: {
                                a: {
                                    color: o(e("danger-dark"), e("danger-bg-subtle")),
                                    fontWeight: 500
                                }
                            }
                        }
    ...
    const echartsRevenueTargetInit = () => {
        const {
            getColor: e,
            getData: t
        } = window.phoenix.utils, o = document.querySelector(".echart-revenue-target-conversion"), a = [42e3, 35e3, 35e3, 4e4], r = [30644, 33644, 28644, 38644];
        if (o) {
            const i = t(o, "echarts"),
