(function (factory) {
    ...
    const {
        ...
        const {
            getColor: t,
            getData: e
        } = window.phoenix.utils, o = document.querySelector(".echart-returning-customer");
        if (o) {
            const i = e(o, "echarts"),
                r = echarts$1.init(o);
            echartSetOption(r, i, (() => ({
    ...
    window.revenueMapInit = revenueMapInit, docReady(totalSalesChartInit), docReady(newCustomersChartsInit), docReady(topCouponsChartInit), docReady(projectionVsActualChartInit), docReady(returningCustomerChartInit), docReady(payingCustomerChartInit), docReady(totalOrdersChartInit);
