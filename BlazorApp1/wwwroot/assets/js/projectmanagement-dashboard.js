(function (factory) {
    ...
    const issuesDiscoveredChartInit = () => {
        const {
            ...
            getData: t,
            toggleColor: i
        } = window.phoenix.utils, o = document.querySelector(".echart-issue-chart");
        if (o) {
            const a = t(o, "echarts"),
                r = window.echarts.init(o);
            echartSetOption(r, a, (() => ({
                color: [i(e("info-light"), e("info-dark")), i(e("warning-light"), e("warning-dark")), i(e("danger-light"), e("danger-dark")), i(e("success-light"), e("success-dark")), e("primary")],
                tooltip: {
                    trigger: "item",
    ...
    const zeroBurnOutChartInit = () => {
        const {
            ...
            getData: e,
            getPastDates: t
        } = window.phoenix.utils, r = document.querySelector(".echart-zero-burnout-chart");
        if (r) {
            const i = e(r, "echarts"),
            ...
            echartSetOption(l, i, (() => ({
                ...
                series: [{
                    ...
                    itemStyle: {
                        color: o("body-highlight-bg"),
                        borderColor: o("quaternary-color"),
                        borderWidth: 2
                    },
                    lineStyle: {
    ...
    const zeroRoadmapChartInit = () => {
        const {
            getItemFromStore: t
        } = window.phoenix.utils, e = document.querySelector(".gantt-zero-roadmap");
        if (e) {
            ...
            const n = {
                levels: [{
                    ...
                    scales: [{
                        ...
                        step: 1,
                        format: t => {
                            const e = window.gantt.date.date_to_str("%d %M"),
            ...
            gantt.ext.zoom.init(n), gantt.ext.zoom.setLevel("week"), gantt.ext.zoom.attachEvent("onAfterZoom", (function (t, e) {
                ...
                width: 56,
                resize: !0
            }], gantt.templates.task_class = (t, e, a) => a.task_class, gantt.timeline_cell_class = function (t, e) {
                return "weekend"
            ...
            const o = e.querySelectorAll("input[name=scaleView]"),
                ...
                r = e.querySelector("[data-gantt-links]");
            o.forEach((t => {
