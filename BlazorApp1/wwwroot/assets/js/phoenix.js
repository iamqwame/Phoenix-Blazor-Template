(function (global, factory) {
    ...
    const chatInit = () => {
        const {
            getData: e
        } = window.phoenix.utils, t = ".chat-sidebar", a = ".chat-textarea", c = "[data-chat-thread]", o = "[data-chat-thread-tab]", r = "[data-chat-thread-tab-content]", s = document.querySelector(t), l = document.querySelector(a), n = document.querySelectorAll(c), d = document.querySelector(o), u = document.querySelector(r);
        if (d) {
    ...
    const modalInit = () => {
        ...
        if (o) {
            ...
            o.forEach((o => {
                ...
                } else o.addEventListener("shown.bs.modal", (() => {
    ...
    const {
        echarts: echarts
    } = window, tripReviewChartInit = () => {
        const {
            getData: t,
            getColor: o
        } = window.phoenix.utils, e = document.querySelectorAll(".echart-trip-review");
        e && e.forEach((e => {
            const i = t(e, "options"),
                r = echarts.init(e);
            echartSetOption(r, i, (() => ({
